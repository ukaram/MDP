...
import edu.miu.assignment_3.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun addRow(versionName: String, codeName: String) {
        ...
        tvVersion.setBackgroundResource(R.color.teal_200)
        ...
        tvCodeName.setBackgroundResource(R.color.teal_200)
